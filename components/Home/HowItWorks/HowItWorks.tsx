...
//             <Image
//               src="/images/p1.jpg" // Reference the image directly
//               alt="Family Outdoors"
//               fill
...
//           <div className="relative w-1/2 h-48">
//             <Image
//               src="/images/p2.jpg" // Reference the image directly
//               alt="Family in Home"
//               fill
//               className="rounded-lg object-cover"
//             />
...
//           <Image
//             src="/images/p3.jpg" // Reference the image directly
//             alt="Modern House"
//             fill
//             className="rounded-lg object-cover"
//           />
...
//         {/* Badge */}
//         <div className="absolute top-4 left-4 bg-white p-2 rounded-lg shadow-md flex items-center">
...
//             <div>
//               <h3 className="font-bold text-lg">Find Real Estate</h3>
...
//             <div>
//               <h3 className="font-bold text-lg">Meet Realtor</h3>
//               <p className="text-gray-500 text-sm">Sumo petentium ut per, at his wisi utinam adipiscing. Est ei graeco.</p>
//             </div>
//           </div>
...
//             <div>
//               <h3 className="font-bold text-lg">Take The Keys</h3>
//               <p className="text-gray-500 text-sm">Sumo petentium ut per, at his wisi utinam adipiscing. Est ei graeco.</p>
//             </div>
//           </div>
//         </div>
    ...
    <div className="w-full flex flex-col md:flex-row bg-gray-100 py-16 px-4">
      ...
      <div className="text-left md:w-1/2 md:pl-8 mt-8 md:mt-0">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4 p-4 rounded-lg">
            <div className="flex items-center justify-center w-12 h-12 rounded-full border-2 border-yellow-500">
              <FaKey className="text-yellow-500 text-2xl" />
            </div>
            <div>
              <h3 className="font-bold text-lg">Take The Keys</h3>
              <p className="text-gray-500 text-sm">Sumo petentium ut per, at his wisi utinam adipiscing. Est ei graeco.</p>
